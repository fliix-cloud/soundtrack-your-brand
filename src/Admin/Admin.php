...
class Admin {
	...
	public function __construct( Client $api_client ) {
		...
		add_action( 'wp_ajax_fliix_np_syb_fetch_soundzones', array( $this, 'ajax_fetch_soundzones' ) );
		add_action( 'wp_ajax_fliix_np_syb_save_mappings', array( $this, 'ajax_save_mappings' ) );
	}
	...
	public function enqueue_assets( string $hook_suffix ): void {
		...
		wp_localize_script(
			...
			array(
				...
				'nonce'          => wp_create_nonce( 'fliix_np_syb_admin_nonce' ),
	...
	public function ajax_fetch_soundzones(): void {
		check_ajax_referer( 'fliix_np_syb_admin_nonce', 'nonce' );
		...
		update_option( 'fliix_np_syb_zones_cache', $cache );
	...
	public function ajax_save_mappings(): void {
		...
		update_option( 'fliix_np_syb_soundtrack_mappings', $validation['mappings'] );
