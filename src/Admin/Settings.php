...
use Fliix\SoundtrackYourBrand\Security\TokenStorage;
...
class Settings {
	 ...
	 * Option group name.
	 */
	private const OPTION_GROUP = 'fliix_np_syb_settings';
			...
			<tr data-zone-id="<?php echo esc_attr( $zone_id ); ?>">
				...
				<td data-label="<?php esc_attr_e( 'Slug', 'fliix-now-playing-for-soundtrack-your-brand' ); ?>">
					<input type="text"
						...
						name="fliix_np_syb_slug_<?php echo esc_attr( $zone_id ); ?>"
	...
	public function render_base_url_field(): void {
		$value = get_option( 'fliix_np_syb_api_base_url', 'https://api.soundtrackyourbrand.com/v2' );
		?>
		<input type="url" name="fliix_np_syb_api_base_url" id="fliix_np_syb_api_base_url"
	...
	public function render_token_field(): void {
		...
		?>
		<input type="password" name="fliix_np_syb_api_token" id="fliix_np_syb_api_token"
	...
	public function render_interval_field(): void {
		$value = (int) get_option( 'fliix_np_syb_update_interval', 30 );
		?>
		<input type="number" name="fliix_np_syb_update_interval" id="fliix_np_syb_update_interval"
	...
	public function render_mapping_section(): void {
		...
		echo '<p><code>[fliix_np_syb slug="your-slug-here"]</code></p>';

		$zones_cache = get_option( 'fliix_np_syb_zones_cache', array() );
		if ( ! is_array( $zones_cache ) ) {
			$zones_cache = array();
		}

		$mappings = get_option( 'fliix_np_syb_soundtrack_mappings', array() );
		...
		<div class="syb-display-panel">
			<div class="syb-display-grid">
							...
							<div class="syb-template-picker" role="radiogroup" aria-label="<?php esc_attr_e( 'Template', 'fliix-now-playing-for-soundtrack-your-brand' ); ?>">
								...
								foreach ( $templates as $value => $template ) :
									...
									<label class="syb-template-option">
										<input type="radio" class="syb-template-option__input" name="fliix_np_syb_display_settings[template]"
								...
								<div class="syb-segmented" role="radiogroup" aria-label="<?php esc_attr_e( 'Alignment', 'fliix-now-playing-for-soundtrack-your-brand' ); ?>">
									...
									foreach ( $alignments as $value => $label ) :
										...
										<label class="syb-segmented__item">
											<input type="radio" class="syb-segmented__input" name="fliix_np_syb_display_settings[alignment]"
				...
				<section class="syb-display-card">
					...
					<div class="syb-display-card__body">
						<div class="syb-field">
							<label class="syb-field__label" for="fliix_np_syb_image_display"><?php esc_html_e( 'Display mode', 'fliix-now-playing-for-soundtrack-your-brand' ); ?></label>
							<select name="fliix_np_syb_display_settings[image_display]" id="fliix_np_syb_image_display" class="syb-field__control">
						...
						<div class="syb-field syb-field--inline-controls">
							<label class="syb-field__label" for="fliix_np_syb_image_size"><?php esc_html_e( 'Size', 'fliix-now-playing-for-soundtrack-your-brand' ); ?></label>
							<div class="syb-field__row">
								<select name="fliix_np_syb_display_settings[image_size]" id="fliix_np_syb_image_size" class="syb-field__control">
								...
								<input type="number" name="fliix_np_syb_display_settings[image_size_custom]" id="fliix_np_syb_image_size_custom"
				...
				<section class="syb-display-card">
					...
					<div class="syb-display-card__body">
						<div class="syb-field">
							<label class="syb-field__label" for="fliix_np_syb_prefix_text"><?php esc_html_e( 'Playing label', 'fliix-now-playing-for-soundtrack-your-brand' ); ?></label>
							<input type="text" name="fliix_np_syb_display_settings[prefix_text]" id="fliix_np_syb_prefix_text"
								value="<?php echo esc_attr( $settings['prefix_text'] ); ?>" class="syb-field__control" />
						</div>
						<div class="syb-field">
							<label class="syb-field__label" for="fliix_np_syb_fallback_text"><?php esc_html_e( 'Fallback text', 'fliix-now-playing-for-soundtrack-your-brand' ); ?></label>
							<input type="text" name="fliix_np_syb_display_settings[fallback_text]" id="fliix_np_syb_fallback_text"
					...
					<div class="syb-display-card__body">
						<div class="syb-type-grid">
							<div class="syb-type-column">
								...
								<div class="syb-field">
									<label class="syb-field__label" for="fliix_np_syb_song_color"><?php esc_html_e( 'Color', 'fliix-now-playing-for-soundtrack-your-brand' ); ?></label>
									<input type="text" name="fliix_np_syb_display_settings[song_color]" id="fliix_np_syb_song_color"
										value="<?php echo esc_attr( $settings['song_color'] ); ?>" class="syb-color-picker syb-field__control" data-default-color="#111111" />
								</div>
								<div class="syb-field syb-field--inline-controls">
									<label class="syb-field__label" for="fliix_np_syb_song_font_size"><?php esc_html_e( 'Size (px)', 'fliix-now-playing-for-soundtrack-your-brand' ); ?></label>
									<input type="number" name="fliix_np_syb_display_settings[song_font_size]" id="fliix_np_syb_song_font_size"
										value="<?php echo esc_attr( (string) $settings['song_font_size'] ); ?>" min="8" max="72" class="syb-field__control syb-field__control--narrow" />
								</div>
								<div class="syb-field">
									<label class="syb-field__label" for="fliix_np_syb_song_font_weight"><?php esc_html_e( 'Weight', 'fliix-now-playing-for-soundtrack-your-brand' ); ?></label>
							...
							<div class="syb-type-column">
								...
								<div class="syb-field">
									<label class="syb-field__label" for="fliix_np_syb_artist_color"><?php esc_html_e( 'Color', 'fliix-now-playing-for-soundtrack-your-brand' ); ?></label>
									<input type="text" name="fliix_np_syb_display_settings[artist_color]" id="fliix_np_syb_artist_color"
										value="<?php echo esc_attr( $settings['artist_color'] ); ?>" class="syb-color-picker syb-field__control" data-default-color="#666666" />
								</div>
								<div class="syb-field syb-field--inline-controls">
									<label class="syb-field__label" for="fliix_np_syb_artist_font_size"><?php esc_html_e( 'Size (px)', 'fliix-now-playing-for-soundtrack-your-brand' ); ?></label>
									<input type="number" name="fliix_np_syb_display_settings[artist_font_size]" id="fliix_np_syb_artist_font_size"
										value="<?php echo esc_attr( (string) $settings['artist_font_size'] ); ?>" min="8" max="72" class="syb-field__control syb-field__control--narrow" />
								</div>
								<div class="syb-field">
									<label class="syb-field__label" for="fliix_np_syb_artist_font_weight"><?php esc_html_e( 'Weight', 'fliix-now-playing-for-soundtrack-your-brand' ); ?></label>
							...
							<div class="syb-type-column">
								...
								<div class="syb-field">
									<label class="syb-field__label" for="fliix_np_syb_prefix_color"><?php esc_html_e( 'Color', 'fliix-now-playing-for-soundtrack-your-brand' ); ?></label>
									<input type="text" name="fliix_np_syb_display_settings[prefix_color]" id="fliix_np_syb_prefix_color"
										value="<?php echo esc_attr( $settings['prefix_color'] ); ?>" class="syb-color-picker syb-field__control" data-default-color="#444444" />
								</div>
								<div class="syb-field syb-field--inline-controls">
									<label class="syb-field__label" for="fliix_np_syb_prefix_font_size"><?php esc_html_e( 'Size (px)', 'fliix-now-playing-for-soundtrack-your-brand' ); ?></label>
									<input type="number" name="fliix_np_syb_display_settings[prefix_font_size]" id="fliix_np_syb_prefix_font_size"
	...
	private function render_display_toggle( string $name, string $label, bool $checked ): void {
		...
		<div class="syb-toggle">
			<input type="hidden" name="fliix_np_syb_display_settings[<?php echo esc_attr( $name ); ?>]" value="0" />
			<label class="syb-toggle__label-wrap">
				<input type="checkbox" class="syb-toggle__input" name="fliix_np_syb_display_settings[<?php echo esc_attr( $name ); ?>]"
	...
	private function render_font_weight_select( string $name, string $value ): void {
		...
		?>
		<select name="fliix_np_syb_display_settings[<?php echo esc_attr( $name ); ?>]" id="fliix_np_syb_<?php echo esc_attr( $name ); ?>" class="syb-field__control">
